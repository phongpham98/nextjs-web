...
const Mobile = dynamic(() => import('@components/modules/news/NewsPageMobile'), { ssr: false })
const Desktop = dynamic(() => import('@components/modules/news/NewsPageDesktop'), { ssr: false })

const News: InferGetStaticPropsType<typeof getStaticProps> = (props: Props) => {
	...
	return (
		<>
			<SEO
				title={t('news', { ns: 'title' })}
				description={t('seo.description')}
				imgSrc='/seo_image/news.png'
