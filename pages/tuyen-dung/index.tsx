...
const Mobile = dynamic(() => import('@components/modules/career/CareerMobile'), { ssr: false })
const Desktop = dynamic(() => import('@components/modules/career/CareerDesktop'), { ssr: false })

const CareerPage: InferGetStaticPropsType<typeof getStaticProps> = (props: Props) => {
	...
	return (
		<>
			<SEO
				title={t('career', { ns: 'title' })}
				description={t('seo.description')}
				imgSrc='/seo_image/career.png'
